...
TOPIC = "bus_gps_raw"
CATALOG_TABLE = "iceberg.bus_gps_raw"  # phải khớp với spark-defaults.conf
...
""")
print("Start to read stream from bus_raw_gps topic")
...
checkpoint = "s3a://warehouse/checkpoints/bus_gps_raw"  # hoặc path local /tmp/checkpoints/...
