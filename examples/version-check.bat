...
findstr /C:"ENV.*VERSION" docker\spark\Dockerfile >nul 2>&1 && echo   Dockerfile: Environment variables configured
findstr /C:"SPARK_JARS_PACKAGES" docker-compose.yml >nul 2>&1 && echo   Docker-compose: Services configured
