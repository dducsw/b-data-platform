...
TOPIC = "bus_gps_raw"
CATALOG_TABLE = "iceberg.test.bus_gps"
...
print("Start to read stream from bus_gps topic")
...
checkpoint = "s3a://lake/checkpoints/bus_gps"  # hoặc path local /tmp/checkpoints/...
